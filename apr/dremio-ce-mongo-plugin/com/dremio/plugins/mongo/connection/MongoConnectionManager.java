...
public class MongoConnectionManager implements AutoCloseable
{
    ...
    public MongoConnectionManager(final MongoConf config, final String pluginName) {
        ...
        if (AuthenticationType.MASTER.equals((Object)config.authenticationType)) {
            ...
            connection.append("@");
            appendHosts(connection, (Iterable<Host>)Preconditions.checkNotNull((Object)config.hostList, (Object)"hostList missing"), ',').append("/");
        ...
        connection.append(FluentIterable.from((Iterable)properties).transform((Function)new Function<Property, String>() {
    ...
    private static StringBuilder appendHosts(final StringBuilder sb, final Iterable<Host> hostList, final char delimiter) {
        ...
        while (iterator.hasNext()) {
            ...
            sb.append((String)Preconditions.checkNotNull((Object)h.hostname, (Object)"hostname missing")).append(":").append(Preconditions.checkNotNull((Object)h.port, (Object)"port missing"));
            if (iterator.hasNext()) {
                sb.append(delimiter);
            }
        }
    ...
    public MongoConnection getFirstConnection() {
        ...
        return this.getClient((List<ServerAddress>)ImmutableList.of((Object)address), this.authTimeoutInMillis);
    }
    ...
    private synchronized MongoConnection getClient(final List<ServerAddress> addresses, final long serverSelectionTimeout) {
        ...
        if (client == null) {
            ...
            if (addresses.size() > 1) {
                client = new MongoClient((List)addresses, (List)credentials, localClientOptions);
            }
            else {
                client = new MongoClient((ServerAddress)addresses.get(0), (List)credentials, localClientOptions);
            }
            this.addressClientMap.put((Object)key, (Object)client);
            MongoConnectionManager.logger.info("Created connection to {}.", (Object)key.toString());
            MongoConnectionManager.logger.info("Number of open connections {}.", (Object)this.addressClientMap.size());
    ...
    public MongoVersion validateConnection() {
        ...
        if (fetchResult != null && !fetchResult.isEmpty()) {
            ...
            if (this.authDatabase != null) {
                ...
                MongoConnectionManager.logger.debug("Connected as anonymous user. Found {} collections. {}", (Object)fetchResult.getNumDatabases(), (Object)topology);
            }
    ...
    static {
        logger = LoggerFactory.getLogger((Class)MongoConnectionManager.class);
    }
    ...
    private class AddressCloser implements RemovalListener<MongoConnectionKey, MongoClient>
    {
        public synchronized void onRemoval(final RemovalNotification<MongoConnectionKey, MongoClient> removal) {
            ...
            MongoConnectionManager.logger.debug("Closed connection to {}.", (Object)((MongoConnectionKey)removal.getKey()).toString());
        }
    }
}
