...
public class MongoTable implements DatasetHandle
{
    ...
    private BatchSchema getSampledSchema(final BatchSchema oldSchema) throws Exception {
        ...
        final ImmutableList<SchemaPath> columns = (ImmutableList<SchemaPath>)ImmutableList.of((Object)SchemaPath.getSimplePath("*"));
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        if (oldSchema != null) {
                            oldSchema.materializeVectors((List)GroupScan.ALL_COLUMNS, (OutputMutator)mutator);
                        }
                        while (true) {
                            try {
