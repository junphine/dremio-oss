...
public class MongoScanPrel extends TableScan implements LeafPrel, CustomPrel
{
    ...
    public RelWriter explainTerms(final RelWriter pw) {
        return super.explainTerms(pw).item("MongoQuery", (Object)this.spec.getMongoQuery());
    }
    ...
    public <T, X, E extends Throwable> T accept(final PrelVisitor<T, X, E> logicalVisitor, final X value) throws E, Throwable {
        return (T)logicalVisitor.visitLeaf((LeafPrel)this, (Object)value);
    }
    ...
    static {
        logger = LoggerFactory.getLogger((Class)MongoScanPrel.class);
