...
public class MongoIntermediatePrel extends SinglePrel implements PrelFinalizable, MongoRel
{
    ...
    public RelNode copy(final RelTraitSet traitSet, final List<RelNode> inputs) {
        Preconditions.checkArgument(inputs.size() == 1, "must have one input: %s", (Object)inputs);
    ...
    public Prel finalizeRel() {
        ...
        final PlannerSettings settings = (PlannerSettings)this.getCluster().getPlanner().getContext().unwrap((Class)PlannerSettings.class);
    ...
    static {
        logger = LoggerFactory.getLogger((Class)MongoIntermediatePrel.class);
