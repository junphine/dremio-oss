...
public final class RexToFilterDocumentUtils
{
    ...
    static Object getMongoFormattedLiteral(final RexLiteral literal, final CompleteType typeOfFieldBeingCompared) {
        return getLiteralDocument(literal, typeOfFieldBeingCompared).get((Object)MongoFunctions.LITERAL.getMongoOperator());
    }
    ...
    static Document getLiteralDocument(final RexLiteral literal, final CompleteType typeOfFieldBeingCompared) {
        ...
        String val;
        if (literalSqlType.equals((Object)SqlTypeName.DATE) || literalSqlType.equals((Object)SqlTypeName.TIMESTAMP) || literalSqlType.equals((Object)SqlTypeName.TIME)) {
            val = formatDateTimeLiteralAsISODateString(literal.toString());
        }
        else if (null != typeOfFieldBeingCompared && typeOfFieldBeingCompared.isTemporal() && literal.getType().getSqlTypeName().equals((Object)SqlTypeName.VARCHAR)) {
        ...
        else if (null != typeOfFieldBeingCompared && typeOfFieldBeingCompared.isDecimal() && literal.getType().getSqlTypeName().equals((Object)SqlTypeName.DECIMAL)) {
