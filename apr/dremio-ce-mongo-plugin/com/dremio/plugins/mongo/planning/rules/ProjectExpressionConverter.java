...
public class ProjectExpressionConverter extends RexVisitorImpl<Object>
{
    ...
    protected Document getLiteralDocument(final RexLiteral literal) {
        ...
        String val;
        if (literal.getType().getSqlTypeName().equals((Object)SqlTypeName.DATE) || literal.getType().getSqlTypeName().equals((Object)SqlTypeName.TIMESTAMP) || literal.getType().getSqlTypeName().equals((Object)SqlTypeName.TIME)) {
            val = "ISODate(\"" + new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSS'Z'").format(Timestamp.valueOf(literal.toString())) + "\")";
        }
        else if (null != this.leftFieldType && this.leftFieldType.isTemporal() && literal.getType().getSqlTypeName().equals((Object)SqlTypeName.VARCHAR)) {
        ...
        else if (null != this.leftFieldType && this.leftFieldType.isDecimal() && literal.getType().getSqlTypeName().equals((Object)SqlTypeName.DECIMAL)) {
    ...
    public Object visitLiteral(final RexLiteral literal) {
        return new Document(MongoFunctions.LITERAL.getMongoOperator(), this.getLiteralDocument(literal).get((Object)MongoFunctions.LITERAL.getMongoOperator()));
    }
        ...
        switch (rightInput.getType().getSqlTypeName()) {
            ...
            case INTEGER: {
                ...
                if (hitArrayIndex) {
                    ...
                    return (Pair<Object, Boolean>)new Pair((Object)this.constructJson(MongoFunctions.ARRAYELEMAT.getMongoOperator(), leftInputObject, val), (Object)true);
                }
                else {
            ...
            case VARCHAR: {
                ...
                return (Pair<Object, Boolean>)new Pair((Object)(leftInputObject + rightInputConvStr), (Object)hitArrayIndex);
            }
            default: {
                throw new RuntimeException("error converting item expression, second argument not a literal or varchar or number");
            }
    ...
    private Document constructJson(final String opName, final Object... args) {
        return new Document(opName, (Object)Arrays.asList(args));
    }
    ...
    static {
        logger = LoggerFactory.getLogger((Class)ProjectExpressionConverter.class);
