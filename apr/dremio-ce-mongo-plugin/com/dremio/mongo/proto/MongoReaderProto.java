...
public final class MongoReaderProto
{
    ...
    public enum CollectionType implements ProtocolMessageEnum
    {
        ...
        static {
            internalValueMap = (Internal.EnumLiteMap)new Internal.EnumLiteMap<CollectionType>() {
    ...
    public static final class MongoTableXattr extends GeneratedMessageV3 implements MongoTableXattrOrBuilder
    {
        ...
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return MongoReaderProto.internal_static_com_dremio_elastic_proto_MongoTableXattr_fieldAccessorTable.ensureFieldAccessorsInitialized((Class)MongoTableXattr.class, (Class)Builder.class);
        }
        ...
        public static MongoTableXattr parseFrom(final ByteBuffer data) throws InvalidProtocolBufferException {
            return (MongoTableXattr)MongoTableXattr.PARSER.parseFrom(data);
        }
        ...
        public static MongoTableXattr parseFrom(final ByteBuffer data, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (MongoTableXattr)MongoTableXattr.PARSER.parseFrom(data, extensionRegistry);
        }
        ...
        public static MongoTableXattr parseFrom(final InputStream input) throws IOException {
            return (MongoTableXattr)GeneratedMessageV3.parseWithIOException((Parser)MongoTableXattr.PARSER, input);
        }
        ...
        public static MongoTableXattr parseFrom(final InputStream input, final ExtensionRegistryLite extensionRegistry) throws IOException {
            return (MongoTableXattr)GeneratedMessageV3.parseWithIOException((Parser)MongoTableXattr.PARSER, input, extensionRegistry);
        }
        
        public static MongoTableXattr parseDelimitedFrom(final InputStream input) throws IOException {
            return (MongoTableXattr)GeneratedMessageV3.parseDelimitedWithIOException((Parser)MongoTableXattr.PARSER, input);
        }
        ...
        public static MongoTableXattr parseDelimitedFrom(final InputStream input, final ExtensionRegistryLite extensionRegistry) throws IOException {
            return (MongoTableXattr)GeneratedMessageV3.parseDelimitedWithIOException((Parser)MongoTableXattr.PARSER, input, extensionRegistry);
        }
        ...
        static {
            ...
            PARSER = (Parser)new AbstractParser<MongoTableXattr>() {
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements MongoTableXattrOrBuilder
        {
            ...
            public MongoTableXattr buildPartial() {
                final MongoTableXattr result = new MongoTableXattr((GeneratedMessageV3.Builder)this);
    ...
    public static final class MongoSplitXattr extends GeneratedMessageV3 implements MongoSplitXattrOrBuilder
    {
        ...
        protected GeneratedMessageV3.FieldAccessorTable internalGetFieldAccessorTable() {
            return MongoReaderProto.internal_static_com_dremio_elastic_proto_MongoSplitXattr_fieldAccessorTable.ensureFieldAccessorsInitialized((Class)MongoSplitXattr.class, (Class)Builder.class);
        }
        ...
        public boolean equals(final Object obj) {
            ...
            return this.hasMinFilter() == other.hasMinFilter() && (!this.hasMinFilter() || this.getMinFilter().equals(other.getMinFilter())) && this.hasMaxFilter() == other.hasMaxFilter() && (!this.hasMaxFilter() || this.getMaxFilter().equals(other.getMaxFilter())) && this.getHostsList().equals(other.getHostsList()) && this.unknownFields.equals((Object)other.unknownFields);
        }
        ...
        public static MongoSplitXattr parseFrom(final ByteBuffer data) throws InvalidProtocolBufferException {
            return (MongoSplitXattr)MongoSplitXattr.PARSER.parseFrom(data);
        }
        ...
        public static MongoSplitXattr parseFrom(final ByteBuffer data, final ExtensionRegistryLite extensionRegistry) throws InvalidProtocolBufferException {
            return (MongoSplitXattr)MongoSplitXattr.PARSER.parseFrom(data, extensionRegistry);
        }
        ...
        public static MongoSplitXattr parseFrom(final InputStream input) throws IOException {
            return (MongoSplitXattr)GeneratedMessageV3.parseWithIOException((Parser)MongoSplitXattr.PARSER, input);
        }
        ...
        public static MongoSplitXattr parseFrom(final InputStream input, final ExtensionRegistryLite extensionRegistry) throws IOException {
            return (MongoSplitXattr)GeneratedMessageV3.parseWithIOException((Parser)MongoSplitXattr.PARSER, input, extensionRegistry);
        }
        
        public static MongoSplitXattr parseDelimitedFrom(final InputStream input) throws IOException {
            return (MongoSplitXattr)GeneratedMessageV3.parseDelimitedWithIOException((Parser)MongoSplitXattr.PARSER, input);
        }
        ...
        public static MongoSplitXattr parseDelimitedFrom(final InputStream input, final ExtensionRegistryLite extensionRegistry) throws IOException {
            return (MongoSplitXattr)GeneratedMessageV3.parseDelimitedWithIOException((Parser)MongoSplitXattr.PARSER, input, extensionRegistry);
        }
        ...
        static {
            ...
            PARSER = (Parser)new AbstractParser<MongoSplitXattr>() {
        ...
        public static final class Builder extends GeneratedMessageV3.Builder<Builder> implements MongoSplitXattrOrBuilder
        {
            ...
            public MongoSplitXattr buildPartial() {
                final MongoSplitXattr result = new MongoSplitXattr((GeneratedMessageV3.Builder)this);
                final int from_bitField0_ = this.bitField0_;
                int to_bitField0_ = 0;
                if ((from_bitField0_ & 0x1) != 0x0) {
                    to_bitField0_ |= 0x1;
            ...
            public Builder mergeFrom(final MongoSplitXattr other) {
                ...
                if (!other.hosts_.isEmpty()) {
                    if (this.hosts_.isEmpty()) {
                        ...
                        this.hosts_.addAll((Collection)other.hosts_);
                    }
                    this.onChanged();
                }
                this.mergeUnknownFields(other.unknownFields);
            ...
            public Builder setHosts(final int index, final String value) {
                ...
                this.ensureHostsIsMutable();
                this.hosts_.set(index, (Object)value);
                this.onChanged();
                return this;
            }
            ...
            public Builder addAllHosts(final Iterable<String> values) {
                this.ensureHostsIsMutable();
                AbstractMessageLite.Builder.addAll((Iterable)values, (List)this.hosts_);
                this.onChanged();
                return this;
            }
