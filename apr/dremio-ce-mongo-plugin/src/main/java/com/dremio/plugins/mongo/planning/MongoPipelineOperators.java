...
public enum MongoPipelineOperators
{
    ...
    static {
        PROJECT_ONLY = Sets.newHashSet(new MongoPipelineOperators[] { MongoPipelineOperators.PROJECT });
        MATCH_ONLY = Sets.newHashSet(new MongoPipelineOperators[] { MongoPipelineOperators.MATCH });
        PROJECT_MATCH = Sets.newHashSet(new MongoPipelineOperators[] { MongoPipelineOperators.PROJECT, MongoPipelineOperators.MATCH });
    }
}
