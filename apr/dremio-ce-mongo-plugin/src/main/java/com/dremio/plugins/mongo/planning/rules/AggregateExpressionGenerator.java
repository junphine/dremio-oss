        ...
        switch (rightInput.getType().getSqlTypeName()) {
            ...
            case INTEGER: {
                ...
                if (hitArrayIndex) {
                    ...
                    return (Pair<Object, Boolean>)new Pair(RexToFilterDocumentUtils.constructOperatorDocument(MongoFunctions.ARRAYELEMAT.getMongoOperator(), leftInputObject, val), true);
                }
                else {
            ...
            case VARCHAR: {
                ...
                return (Pair<Object, Boolean>)new Pair(String.format("%s.%s", leftInputObject, rightLitString), hitArrayIndex);
            }
            default: {
