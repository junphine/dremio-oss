...
public final class OracleDialect extends ArpDialect
{
    ...
    public boolean supportsLiteral(final CompleteType type) {
        return !CompleteType.BIT.equals(type) && (CompleteType.INT.equals(type) || CompleteType.BIGINT.equals(type) || CompleteType.DATE.equals(type) || super.supportsLiteral(type));
    }
