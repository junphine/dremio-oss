...
public abstract class LegacyCapableJdbcConf<T extends AbstractArpConf<T>> extends AbstractArpConf<T>
{
    ...
    public JdbcDremioSqlDialect getDialect() {
        ...
        Preconditions.checkArgument(arpDialect.getDatabaseProduct() == legacyDialect.getDatabaseProduct(), (Object)"Legacy dialect and ARP dialect should be for the same Database product.");
