...
public class OracleConf extends LegacyCapableJdbcConf<OracleConf>
{
    ...
    private CloseableDataSource newDataSource(final CredentialsService credentialsService) throws SQLException {
        if (Strings.isNullOrEmpty(this.secretResourceUrl)) {
            Preconditions.checkNotNull((Object)this.username, (Object)"missing username");
            Preconditions.checkNotNull((Object)this.password, (Object)"missing password");
        }
        Preconditions.checkNotNull((Object)this.hostname, (Object)"missing hostname");
        Preconditions.checkNotNull((Object)this.port, (Object)"missing port");
        Preconditions.checkNotNull((Object)this.instance, (Object)"missing instance");
    ...
    CloseableDataSource newDataSource(final ConnectionPoolDataSource dataSource, final CredentialsService credentialsService) throws SQLException {
        ...
        ((Hashtable<String, String>)properties).put("oracle.jdbc.timezoneAsRegion", Boolean.toString(this.useTimezoneAsRegion));
        ((Hashtable<String, String>)properties).put("includeSynonyms", Boolean.toString(this.includeSynonyms));
        ...
        if (!Strings.isNullOrEmpty(this.sslServerCertDN)) {
            ...
            ((Hashtable<String, String>)properties).put("oracle.net.ssl_server_dn_match", "true");
        }
        else {
            securityOption = "";
        }
    ...
    private static CloseableDataSource newDataSource(final ConnectionPoolDataSource source, final String url, final String username, final String password, final Properties properties) throws SQLException {
        try {
            ...
            if (properties != null) {
                MethodUtils.invokeExactMethod((Object)source, "setConnectionProperties", new Object[] { properties });
            }
            MethodUtils.invokeExactMethod((Object)source, "setUser", new Object[] { username });
            MethodUtils.invokeExactMethod((Object)source, "setPassword", new Object[] { password });
