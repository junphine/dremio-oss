...
public class PostgresConf extends LegacyCapableJdbcConf<PostgresConf>
{
    ...
    private String toJdbcConnectionString() {
        ...
        final String db = (String)Preconditions.checkNotNull((Object)this.databaseName, (Object)"missing database");
        return String.format("jdbc:postgresql://%s:%d/%s", hostname, port, db);
    }
    
    private String getSslMode() {
        Preconditions.checkNotNull((Object)this.encryptionValidationMode, (Object)"missing validation mode");
