        ...
        switch (node.getKind()) {
            case LITERAL: {
                ...
                Label_0252: {
                    switch (literal.getTypeName().getFamily()) {
                        case BOOLEAN: {
                            return (Pair<Boolean, Boolean>)Pair.of((Object)true, (Object)true);
                        }
                        case CHARACTER:
                        case NUMERIC:
                        case EXACT_NUMERIC:
                        ...
                        case TIMESTAMP: {
                            if (null != dialect && !dialect.supportsLiteral(SourceTypeDescriptor.getType(literal.getType()))) {
                                return (Pair<Boolean, Boolean>)Pair.of((Object)false, (Object)false);
                            }
                            return (Pair<Boolean, Boolean>)Pair.of((Object)true, (Object)false);
                        }
                        case ANY:
                        case NULL: {
            ...
            case OR: {
                ...
                for (final RexNode operand : ((RexCall)node).getOperands()) {
                    if (!satisfiesPrecondition(operand) && !operand.getKind().equals((Object)SqlKind.INPUT_REF) && !operand.getType().getSqlTypeName().equals((Object)SqlTypeName.BOOLEAN) && !dialect.supportsLiteral(CompleteType.BIT)) {
                        return (Pair<Boolean, Boolean>)Pair.of((Object)false, (Object)foundBoolean);
                    }
                    final Pair<Boolean, Boolean> opResult = canJoinOnCondition(operand, dialect);
                    if (!(boolean)opResult.left) {
                        return (Pair<Boolean, Boolean>)Pair.of((Object)false, (Object)opResult.right);
                    }
                ...
                return (Pair<Boolean, Boolean>)Pair.of((Object)true, (Object)foundBoolean);
            }
            ...
            case IS_NOT_NULL: {
                ...
                return (Pair<Boolean, Boolean>)Pair.of((Object)(operands.size() == 1 && operands.get(0) instanceof RexInputRef), (Object)false);
            }
            case INPUT_REF: {
                return (Pair<Boolean, Boolean>)Pair.of((Object)true, (Object)false);
            }
                    ...
                    if (call.getOperator() instanceof SqlFunction && ((SqlFunction)call.getOperator()).getFunctionType().isFunction()) {
                        ...
                        for (final RexNode operand2 : ((RexCall)node).getOperands()) {
                            ...
                            if (!(boolean)opResult2.left) {
                                return (Pair<Boolean, Boolean>)Pair.of((Object)false, (Object)opResult2.right);
                            }
                        ...
                        return (Pair<Boolean, Boolean>)Pair.of((Object)true, (Object)foundBoolean2);
                    }
                }
                return (Pair<Boolean, Boolean>)Pair.of((Object)false, (Object)false);
            }
