...
public final class JdbcLimitRule extends JdbcUnaryConverterRule
{
    ...
    public boolean matches(final RelOptRuleCall call) {
        ...
        JdbcLimitRule.logger.debug("Checking if Limit node {} is supported using supportsSort().", (Object)limit);
        ...
        if (!isSortSupported) {
            JdbcLimitRule.logger.debug("Limit '{}' is unsupported. Aborting pushdown.", (Object)limit);
            return false;
        }
        JdbcLimitRule.logger.debug("Limit '{}' is supported.", (Object)limit);
        return true;
    }
