...
public class JdbcGroupScan extends AbstractBase implements GroupScan<CompleteWork>
{
    ...
    public <T, X, E extends Throwable> T accept(final PhysicalVisitor<T, X, E> physicalVisitor, final X value) throws E, Throwable {
        return (T)physicalVisitor.visitGroupScan((GroupScan)this, (Object)value);
    }
    ...
    public Iterator<CompleteWork> getSplits(final ExecutionNodeMap nodeMap) {
        return (Iterator<CompleteWork>)Iterators.singletonIterator((Object)new SimpleCompleteWork(1L, new EndpointAffinity[0]));
    }
    ...
    public boolean equals(final Object o) {
        ...
        return Objects.equal((Object)this.sql, (Object)that.sql) && Objects.equal((Object)this.columns, (Object)that.columns) && Objects.equal((Object)this.pluginId.getConfig(), (Object)that.pluginId.getConfig()) && Objects.equal((Object)this.schema, (Object)that.schema) && Objects.equal((Object)this.tableList, (Object)that.tableList) && Objects.equal((Object)this.skippedColumns, (Object)that.skippedColumns) && Objects.equal((Object)this.columnProperties, (Object)that.columnProperties);
    }
