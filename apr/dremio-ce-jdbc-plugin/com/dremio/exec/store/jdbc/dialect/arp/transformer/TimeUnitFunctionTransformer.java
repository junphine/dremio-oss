...
public final class TimeUnitFunctionTransformer extends CallTransformer
{
    ...
    static {
        ...
        operators = opBuilder.add((Object)new SqlOperatorImpl("DATE_TRUNC", 2, true)).add((Object)SqlStdOperatorTable.TIMESTAMP_ADD).add((Object)SqlStdOperatorTable.TIMESTAMP_DIFF).add((Object)SqlStdOperatorTable.EXTRACT).build();
    }
}
