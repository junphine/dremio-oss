...
class Signature
{
    ...
    Signature(final String returnType, final List<String> args) {
        ...
        this.args = args.stream().map((Function<? super Object, ?>)Mapping::convertDremioTypeStringToCompleteType).collect((Collector<? super Object, ?, List<CompleteType>>)Collectors.toList());
    }
