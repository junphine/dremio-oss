    ...
    private static BatchSchema getExternalQueryMetadataFromSource(final DataSource source, final JdbcDremioSqlDialect dialect, final String query, final String sourceName) throws SQLException {
        ...
        try {
            ...
            try {
                ...
                return BatchSchema.newBuilder().addFields((Iterable)mappings.stream().map((Function<? super Object, ?>)JdbcToFieldMapping::getField).collect((Collector<? super Object, ?, List<? super Object>>)Collectors.toList())).build();
            }
            catch (Throwable t) {
                x2 = t;
                throw t;
