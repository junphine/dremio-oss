...
public abstract class JdbcDremioRelToSqlConverter extends DremioRelToSqlConverter
{
    ...
    public abstract class JdbcDremioContext extends DremioRelToSqlConverter.DremioContext
    {
        protected JdbcDremioContext(final int fieldCount) {
            super((DremioRelToSqlConverter)JdbcDremioRelToSqlConverter.this, fieldCount);
        }
            ...
            switch (rex.getKind()) {
                ...
                case EXISTS: {
                    ...
                    if (subQuery.rel instanceof JdbcTableScan && rex.getKind() == SqlKind.EXISTS) {
                        ...
                        final JdbcProject project = new JdbcProject(tableScan.getCluster(), tableScan.getTraitSet(), (RelNode)tableScan, (List<? extends RexNode>)ImmutableList.of((Object)literalOne), builder.build(), tableScan.getPluginId());
        ...
        public SqlNode field(int ordinal) {
            for (final Map.Entry<String, RelDataType> alias : this.getAliases().entrySet()) {
                ...
                if (ordinal < fields.size()) {
                    ...
                    return (SqlNode)new SqlIdentifier((List)((!this.qualified && !JdbcDremioRelToSqlConverter.access$500(JdbcDremioRelToSqlConverter.this.getJdbcDremioRelToSqlConverter())) ? ImmutableList.of((Object)field.getName()) : ImmutableList.of((Object)alias.getKey(), (Object)field.getName())), collation, SqlImplementor.POS, (List)null);
                }
                else {
                    ordinal -= fields.size();
                }
            }
            throw new AssertionError((Object)("field ordinal " + ordinal + " out of range " + this.getAliases()));
        }
